        ...
        function (error, response, body) {
            ...
            for (var i = 0; i <= 10; i++) {
                ...
                if (videoid !== undefined &&
                    ...
                    var imglink = $(`#results ol li:nth-child(2) li:nth-child(${i}) div:nth-child(1)`).find("img").attr("data-thumb");

                    if (imglink === undefined) {
                        var newImageLink = $(`#results ol li:nth-child(2) li:nth-child(${i}) div:nth-child(1)`).find("img").attr("src");
